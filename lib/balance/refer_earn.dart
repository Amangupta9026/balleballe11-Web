                      ...
                      body: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(top: 35.0, bottom: 15),
                              child: Text(
                                "Referral Code:",
                                style: Theme.of(context)
                                    .textTheme
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  ...
                                  onPrimary:
                                      ColorConstant.COLOR_TEXT, // foreground
                                ),
                                onPressed: () async {
                                  await Share.share(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ListTile(
                                    leading: CircleAvatar(
                                      backgroundImage:
                                          AssetImage(ImgConstants.REFER_EARN3),
                                    ),
                                    title: Text(
                                      "Signup & deposit",
                                      style: Theme.of(context)
                                  ...
                                  ListTile(
                                    leading: CircleAvatar(
                                      backgroundImage:
                                          AssetImage(ImgConstants.REFER_EARN4),
                                    ),
                                    title: Text(
                                      "Earn ₹100",
                                      style: Theme.of(context)
                                  ...
                                  ListTile(
                                    leading: CircleAvatar(
                                      backgroundImage:
                                          AssetImage(ImgConstants.REFER_EARN5),
                                    ),
                                    title: Text(
                                      "You Get 20% lifetime",
                                      style: Theme.of(context)
