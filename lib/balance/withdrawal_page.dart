...
class _WithdrawPageState extends State<WithdrawPage> {
  ...
  //         await APIServices.withdrawWinningAmount(
                          ...
                          if (paytm) {
                            if (withdrawalAmount < 200) {
                              UtilsFlushBar.showDefaultSnackbar(context,
                                  "Withdrawal Amount cannot be less than 200 RS.");
                              ...
                              //  _apiWithdrawalAmount(context);
                              showAlertDialog(context);
                            } else if (withdrawalAmount > 5000) {
                              UtilsFlushBar.showDefaultSnackbar(context,
                                  "Withdrawal Amount cannot be grater than 5000 RS.");
                            } else {
                              //   _apiWithdrawalAmount(context);
                            }
                          } else if (bank) {
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      // title: Text("My title"),
      content: Text("Payment Withdrawal Success"),
      actions: [
        okButton,
      ],
    );
