          ...
          return Row(
            children: [
              ...
              widget.i <= 1
                  ...
                  //   child: Checkbox(
                  //     value:
                  //         _getMyTeamResponseModel.response.myteam[index].isTeamSelect,
                  //     // shape: RoundedRectangleBorder(
                  //     //   borderRadius: BorderRadius.circular(10),
                  //     // ),
                  //     onChanged: (bool value) {
                  //       setState(() {
                  //         _getMyTeamResponseModel.response.myteam.contains((element) {
                              ...
                              setState(() {
                                ...
                                for (var isAllTeamSelect
                                    in _getMyTeamResponseModel
                                        .response.myteam) {
                                  isAllTeamSelect.isTeamSelect = value;
