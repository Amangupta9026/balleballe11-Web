                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ScrollConfiguration(
                          ...
                          child: Padding(
                            padding:
                                const EdgeInsets.fromLTRB(10.0, 10, 10, 40),
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => MatchContestByLiveCompleted(
                      selectedMatchData:
                          _completedMatchLists[completematchIndex] ?? null,
                      teama: joinedmatchdata[index].teama?.shortName,
                      teamb: joinedmatchdata[index].teamb?.shortName,
                      status: joinedmatchdata[index].statusStr,
                      pageFromMatch: StringConstant.COMPLETED_MATCHES),
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => MatchLiveCompleted(
                  selectedMatchData:
                      _liveMatchLists[0].live[joinedLivematchIndex] ?? null,
                  pageFromMatch: StringConstant.LIVE_MATCHES,
                ),
              ),
            );
        ...
        child: ScrollConfiguration(
          ...
          child: Column(
            children: [
              // Visibility(
              //     visible:
              //         upcomingmatchdata[index].singlePlayerAvailable > 0 ?? 0,
              //     child: Row(
              //       mainAxisAlignment: MainAxisAlignment.center,
              //       children: [
              //         Image.asset(
