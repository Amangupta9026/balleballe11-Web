                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            setState(() {
                                              ...
                                              _isPointWiseSelected =
                                                  !_isPointWiseSelected;
                                              if (_isPointWiseSelected) {
                                                if (_isWkPlayers) {
                                                  _wkSquadList.sort((a, b) =>
                                                      b.playerPoints.compareTo(
                                                          a.playerPoints));
                                                } else if (_isBowlPlayers) {
                                                  _bowlersSquadList.sort((a,
                                                          b) =>
                                                      b.playerPoints.compareTo(
                                                          a.playerPoints));
                                                  // _bowlersSquadList.sort(
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) =>
                                                ChooseCaptainPage(
                                              wkSelectedList:
                                                  _wkSelectedSquadList,
                                              batsSelectedList:
                                                  _batsSelectedSquadList,
                                              arSelectedList:
                                                  _arSelectedSquadList,
                                              bowlersSelectedList:
                                                  _bowlersSelectedSquadList,
                                              remainingTime:
                                              ...
                                              selectedMatchData:
                                                  widget?.selectedMatchData,
                                              createTeamMode:
                                                  widget?.createTeamMode,
                                              getMyTeamData:
                                                  widget?.getMyTeamData,
                                            ),
                                          ),
                                        );
                                      }
                                  ...
                                  onTap: () {
                                    setState(() {
                                      ...
                                      if (_isSalBySelected) {
                                        if (_isWkPlayers) {
                                          _wkSquadList.sort((a, b) =>
                                              b.analytics.selection.compareTo(
                                                  a.analytics.selection));
                                        } else if (_isBowlPlayers) {
                                        ...
                                        if (_isWkPlayers) {
                                          _wkSquadList.sort((a, b) =>
                                              a.analytics.selection.compareTo(
                                                  b.analytics.selection));
                                        } else if (_isBowlPlayers) {
                                          _bowlersSquadList.sort((a, b) =>
                                              a.analytics.selection.compareTo(
                                    ...
                                    setState(() {
                                      ...
                                      if (_isRatingWiseSelected) {
                                        if (_isWkPlayers ||
                                            ...
                                            _isARPlayers) {
                                          _wkSquadList.sort((a, b) =>
                                              b.fantasyPlayerRating.compareTo(
                                        ...
                                        if (_isWkPlayers ||
                                            ...
                                            _isARPlayers) {
                                          _wkSquadList.sort((a, b) =>
                                              a.fantasyPlayerRating.compareTo(
                                                  b.fantasyPlayerRating));
                                          _bowlersSquadList.sort((a, b) =>
                                              a.fantasyPlayerRating.compareTo(
                                                  b.fantasyPlayerRating));
                                          _batsSquadList.sort((a, b) =>
